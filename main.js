...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(53);
/* harmony import */ var _fetchInterceptor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52);
...
const fetchInterceptor = new _fetchInterceptor__WEBPACK_IMPORTED_MODULE_3__["default"]()
...
class MacifContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
  ...
  async getPaymentSchedules() {
    ...
    for (const paymentSchedule of foundPaymentSchedules) {
      ...
      const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(foundDate, 'dd/MM/yyyy', new Date())
